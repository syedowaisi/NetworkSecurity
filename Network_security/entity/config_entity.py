...
class DataIngestionConfig:
    def __init__(self,training_pipeline_config:trainingpipelineconfig):
        ...
        self.feature_store_file_path:str=os.path.join(
            self.data_ingestion_dir,training_pipeline.DATA_INGESTION_FEATURE_DIR,training_pipeline.FILE_NAME
        )
...
class DataValidationConfig:
    def __init__(self,training_pipeline_config:trainingpipelineconfig):
        ...
        self.driftreport_filepath:str=os.path.join(
...
class DataTransformationConfig:
    def __init__(self,training_pipeline_config:trainingpipelineconfig):
        ...
        self.transformed_train_filepath:str=os.path.join(
            self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,
            training_pipeline.TRAIN_FILE_NAME.replace("csv","npy"),
        )
        self.transformed_test_filepath:str=os.path.join(
            self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR,
            training_pipeline.TEST_FILE_NAME.replace("csv","npy"),
        )
        self.transformed_object_filepath:str=os.path.join(
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:trainingpipelineconfig):
        ...
        self.trained_model_filepath:str=os.path.join(
        ...
        self.overfitting_underfitting_score:float=training_pipeline.MODEL_TRAINER_OVERFITTING_UNDERFITTING_THRESHOLD